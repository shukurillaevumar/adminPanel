...
const ColorsPage: React.FC = () => {
  ...
  const [editCategory, setEditCategory] = useState<Color | null>(null);
  ...
  useEffect(() => {
    if (editCategory) {
      setNameEn(editCategory.color_en);
      setNameRu(editCategory.color_ru);
      setNameDe(editCategory.color_de);
    }
  }, [editCategory]);
            ...
            <table className="min-w-full border border-gray-200 rounded">
              <thead className="bg-gray-200">
                <tr>
                  ...
                  <th className="py-2 px-4 border">Color ENG</th>
                  <th className="py-2 px-4 border">Color RU</th>
                  <th className="py-2 px-4 border">Color DE</th>
                ...
                {data && data.length > 0 ? (
                  data?.map((element) => (
                    <tr key={element.id} className="text-center">
                      ...
                      <td className="py-2 px-4 border">{element.color_en}</td>
                      <td className="py-2 px-4 border">{element.color_ru}</td>
                      <td className="py-2 px-4 border">{element.color_de}</td>
              ...
              >
                <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <form className="mt-4" onSubmit={createCategory}>
                    <label className="font-semibold">Color Name (EN)</label>
                    <input
                      type="text"
                      ...
                      required
                    />
                    <label className="font-semibold">Color Name (RU)</label>
                    <input
                      type="text"
                      ...
                      required
                    />
                    <label className="font-semibold">Color Name (DE)</label>
                    <input
                      type="text"
